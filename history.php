...
<div class="content">
    <div class="container-fluid">
        ...
        <div class='row'>
            ...
            $numberOfitems = $order->madeAnyOrders($_SESSION["userid"]);
            if ($numberOfitems > 0) {
                ?>
                <h3>History </h3>
                <table class="table table-striped">
                    ...
                    <?php
                    $results = $order->allHistoryList($_SESSION["userid"]);
                    $total = 0;
                ...
                <div class="container">
                    <div class="jumbotron">
                        <h3>You haven't done anything yet. Place <a href="index.php">Order Here</a> here.</h3>
                    </div>
                </div>
                <?php
            }
