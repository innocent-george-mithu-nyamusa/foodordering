...
if(isset($_GET["del_meal"])) {
    $it_id = $_GET["del_meal"];
    $updateQuery = "DELETE FROM food_items WHERE id=?";
    $updateStmt  = $dbh->prepare($updateQuery);
    $updateStmt->bind_param("d", $it_id);
    $updateStmt->execute();
...
<head>
    ...
    <title>Delete Meals | MSU Food Ordering Dashboard</title>
                    ...
                    <div class="widget-content widget-content-area br-6">
                        <table id="alter_pagination" class="table table-hover" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th class="text-center dt-no-sorting">Delete Meal</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
