...
if (isset($_GET["edit_meal_id"])) {
$id = $_GET["edit_meal_id"];
...
<head>
    ...
    <title>Edit Meal | MSU Food Student Food Ordering Dashboard</title>
                        ...
                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form method="post" action="includes/data/updateMeal.php" enctype="multipart/form-data">
                                        <input type="hidden" value="<?php echo $id ?>" name="meal-id" >
...
//                                                session_destroy();
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-2 col-lg-12 col-md-4">
                                                            <div class="upload mt-4 pr-md-4">
                                                                <input type="file" class="dropify" data-default-file="../images/<?php echo $result['images'] ?>" data-max-file-size="2M" name="image"/>
                                                        ...
                                                        <div class="col-xl-10 col-lg-12 col-md-8 mt-md-0 mt-4">
                                                            <div class="form">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="meal-name" class="form-control mb-4" id="fullName" placeholder="Golden Hamburger" value="<?php echo $result['name'] ?>" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="meal-ingredients" class="form-control mb-4" id="profession" placeholder="Bun, Tomatoes, Lettuce" value="<?php echo $result['meal_ingredients'] ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-11 mx-auto">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="meal-description" id="aboutBio" placeholder="<?php echo $result['description'] ?>" rows="10"  required><?php echo $result['description'] ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control mb-4" id="phone" placeholder="Write the Chef name here" value="<?php echo $result['meal_chef'] ?>" name="meal-chef">
                                                            </div>
                                                        </div>
                    ...
                    <div class="account-settings-footer">
                        ...
                        <div class="as-footer-container">
                            ...
                            <button type="reset" id="multiple-reset" class="btn btn-primary">Reset Details</button>
                            <div class="blockui-growl-message">
                                <i class="flaticon-double-check"></i>&nbsp; Settings Saved Successfully
                            </div>
                            <button type="submit" name="update_meal" id="multiple-messages" class="btn btn-success">Update Meal</button>
